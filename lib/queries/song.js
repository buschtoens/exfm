...
/**
 * Find the first occurence of the specified `type` in the Array `arr`.
 * If there's no match than `null` is returned.
 *
 * If the optional `def` is specified, instead of `null` `def` is returned.
 * 
 * @param  {Function} type
 * @param  {Array}    arr
 * @param  {Object}   def
 * @return {Object}   Match or `def` or `null`
 */
